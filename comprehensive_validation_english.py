...
def comprehensive_validation_english():
    """Comprehensive validation of uplift modeling results"""
    ...
    print("Top 15 features with highest treatment correlation:")
    ...
    print("\nTop 15 features with highest response correlation:")
    ...
    # Check for features containing treatment information
    ...
    print(f"\nInteraction features count: {len(interaction_features)}")
    for col in interaction_features[:10]:  # Show only first 10
        print(f"  - {col}")
    ...
    if accuracy_variance > 0.01:
        issues_found.append("Large accuracy variance across different test set sizes, possible overfitting")
    ...
    if len(interaction_features) > 20:
        print("  3. Reduce interaction features to avoid overfitting")
...
if __name__ == "__main__":
    results = comprehensive_validation_english() 